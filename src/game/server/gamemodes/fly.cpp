...
void CGameControllerFLY::OnCharacterSpawn(class CCharacter *pChr)
{
	if(!pChr)
		return;
...
// balancing
bool CGameControllerFLY::CanBeMovedOnBalance(int ClientID) const
{
...
void CGameControllerFLY::OnFlagReturn(CFlag *pFlag)
{
...
// game
bool CGameControllerFLY::DoWincheckMatch()
{
